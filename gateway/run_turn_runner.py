...
class TurnRunner:
    ...
    def progress_callback(self, event_type: str, tool_name: str = None, preview: str = None, args: dict = None, **kwargs):
        ...
        if event_type == "subagent.complete":
            ...
            return
        # Fire on_tool_call_start for dynamic reaction swapping independently of
        # visible progress filtering. The hook carries a snapshot of this turn's
        # message identity and is guarded by the same liveness checks.
        if (
            ...
            try:
                ...
                pass
        # Resolve effective per-tool mode before any other progress routing so
        # "log" and "off" are honored for both chat and live-status rails.
